...
export class Trailhead extends React.PureComponent {
  ...
  render() {
    const {props} = this;
    const {content, utm_term} = props.message;
    const innerClassName = [
      "trailhead",
      content && content.className,
    ].filter(v => v).join(" ");

    return (<ModalOverlayWrapper innerClassName={innerClassName} onClose={this.closeModal} id="trailheadDialog" headerId="trailheadHeader">
      <div className="trailheadInner">
        <div className="trailheadContent">
          ...
          <a className="trailheadLearn" data-l10n-id={content.learn.text.string_id} href={this.props.addUtmParams(content.learn.url)} target="_blank" rel="noopener noreferrer" />
        </div>
          ...
          <form method="get" action={this.props.fxaEndpoint} target="_blank" rel="noopener noreferrer" onSubmit={this.onSubmit}>
            ...
            <p className="trailheadTerms" data-l10n-id="onboarding-join-form-legal">
              <a data-l10n-name="terms" target="_blank" rel="noopener noreferrer"
                href={this.props.addUtmParams("https://accounts.firefox.com/legal/terms")} />
              <a data-l10n-name="privacy" target="_blank" rel="noopener noreferrer"
                href={this.props.addUtmParams("https://accounts.firefox.com/legal/privacy")} />
            </p>
