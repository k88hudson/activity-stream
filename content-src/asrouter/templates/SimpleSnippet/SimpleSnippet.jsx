  ...
  render() {
    ...
    return (<SnippetBase {...props} className={className} textStyle={this.props.textStyle}>
      ...
      <ConditionalWrapper condition={sectionHeader} wrap={this.wrapSnippetContent}>
        <img src={safeURI(props.content.icon.light) || DEFAULT_ICON_PATH} className="icon icon-light-theme" />
        <img src={safeURI(props.content.icon.dark) || DEFAULT_ICON_PATH} className="icon icon-dark-theme" />
        <div>
