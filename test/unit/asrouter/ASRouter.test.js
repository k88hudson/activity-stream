...
describe("ASRouter", () => {
  ...
  describe("#init", () => {
    ...
    it("should dispatch a AS_ROUTER_INITIALIZED event to AS with ASRouterPreferences.specialConditions", async () => {
      ...
      assert.calledWith(Router.dispatchToAS, {type: "AS_ROUTER_INITIALIZED", data: ASRouterPreferences.specialConditions});
    });
  });
  ...
  describe("#overrideOrEnableLegacyOnboarding", () => {
    it("should set the onboarding finished pref to false if it is true and ASRPreferences.allowLegacyOnboarding is false", async () => {
    ...
    it("should set the onboarding finished pref to true if it is false and ASRPreferences.allowLegacyOnboarding is true", async () => {
